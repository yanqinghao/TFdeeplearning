...
if os.path.isfile(save_file_name):
    ...
    zip_url = 'http://archive.ics.uci.edu/mlmachine-learning-databases/00228/smsspamcollection.zip'
...
for i in range(10000):
    ...
    if (i + 1) % 500 == 0:
        ...
        print('Generation # {}. Train Loss (Test Loss): {:.2f}({: .2f}).TrainAcc(TestAcc): {: .2f} ({:.2f})'.format(*acc_and_loss))
